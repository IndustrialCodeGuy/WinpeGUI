...
internal sealed class ExportWimConfirmDialog : Form
{
        ...
        IReadOnlyList<WimImageInfo> images)
    {
        ...
        Label header = new()
        {
            ...
            Text = "Export image to a new WIM?"
        };
        ...
        Label note = new()
        {
            ...
            Height = 46,
            AutoSize = false,
            Text = "The selected image will be exported with maximum WIM compression and integrity checking. Exporting to a new WIM also removes unneeded resource data left by prior WIM servicing."
        };
        ...
        {
            header, source, destination, imageCaption, _description, note, cancel, export
        });
        AcceptButton = export;
        CancelButton = cancel;
        UpdateDescription();
